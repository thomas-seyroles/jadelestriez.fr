...
export default function Design() {
  ...
  return (
    <div className={styles['design-system']}>
      <header className={styles['design-header']}>
      ...
      <section className={styles['design-section']}>
        ...
        <h3 className={styles['color-subtitle']}>Marque</h3>
        ...
        <h3 className={styles['color-subtitle']}>Contraste</h3>
        <div className={styles['color-grid']}>
        ...
        <h3 className={styles['color-subtitle']}>Nuances de Gris</h3>
        <div className={styles['color-grid']}>
      ...
      <section className={styles['design-section']}>
        <h2>Typographie</h2>
        <div className={styles['type-examples']}>
      ...
      <section className={styles['design-section']}>
        ...
        <div className={styles['ui-container']}>
          ...
          <div className={styles['ui-group']} style={{ marginTop: '3rem' }}>
            <h3>Liens de Navigation</h3>
            <nav className={styles['component-row']}>
      ...
      <section className={styles['design-section']}>
        ...
        <div className={styles['icon-grid']}>
            <div className={styles['icon-item']}><FaArrowRight size={24} /> <span>ArrowRight</span></div>
            <div className={styles['icon-item']}><FaCheck size={24} /> <span>Check</span></div>
            <div className={styles['icon-item']}><FaTimes size={24} /> <span>Times</span></div>
            <div className={styles['icon-item']}><FaStar size={24} /> <span>Star</span></div>
        </div>
        <div className={styles['icon-grid']} style={{ marginTop: '2rem' }}>
            <div className={styles['icon-item']}><FaGithub size={24} /> <span>Github</span></div>
            <div className={styles['icon-item']}><FaLinkedin size={24} /> <span>Linkedin</span></div>
            <div className={styles['icon-item']}><FaInstagram size={24} /> <span>Instagram</span></div>
            <div className={styles['icon-item']}><FaEnvelope size={24} /> <span>Envelope</span></div>
            <div className={styles['icon-item']}><FaMapMarkerAlt size={24} /> <span>MapMarker</span></div>
            <div className={styles['icon-item']}><FaPhone size={24} /> <span>Phone</span></div>
        </div>
      </section>
    </div>
  );
